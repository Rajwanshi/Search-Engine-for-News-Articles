...
public:
	...
	void DrawCircleOctants(int x, int y, int x0, int y0)
	{
	...
	void DrawCircle(int x0, int y0, int r)	// arguments-> centre x coordinate, centre y coordinate, radius
	{
		...
		{	
			...
			DrawCircleOctants(x,y, x0, y0); // draw all the symmetrical points
		}
	}
